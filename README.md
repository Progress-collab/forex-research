...
**ВАЖНО**: Все скрипты должны использовать `setup_utf8_encoding()` из `src.utils.encoding` в начале файла для корректного отображения русских букв в Windows консоли.
